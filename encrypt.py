...
def encrypt_data_into_image():
    ...
    success_label = Label(app, text="Successfuly Encrypted!",
...
app.title("Encryption  using steganography")
app.geometry('600x600')
# create a button for calling the function on_click
on_click_button = Button(app, text="Select your Image", bg='white', fg='black', command=on_click)
